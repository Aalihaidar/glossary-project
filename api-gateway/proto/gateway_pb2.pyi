...
class RelationshipDetails(_message.Message):
    __slots__ = ("from_term_id", "to_term_id", "type", "from_term_name", "to_term_name")
    FROM_TERM_ID_FIELD_NUMBER: _ClassVar[int]
    TO_TERM_ID_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    FROM_TERM_NAME_FIELD_NUMBER: _ClassVar[int]
    TO_TERM_NAME_FIELD_NUMBER: _ClassVar[int]
    from_term_id: str
    to_term_id: str
    ...
    def __init__(
        ...
        from_term_name: _Optional[str] = ...,
        to_term_name: _Optional[str] = ...,
    ) -> None: ...

class TermDetails(_message.Message):
    __slots__ = ("term", "relationships")
    TERM_FIELD_NUMBER: _ClassVar[int]
    RELATIONSHIPS_FIELD_NUMBER: _ClassVar[int]
    term: _glossary_pb2.Term
    relationships: _containers.RepeatedCompositeFieldContainer[RelationshipDetails]
    def __init__(
        self,
        term: _Optional[_Union[_glossary_pb2.Term, _Mapping]] = ...,
        relationships: _Optional[
            _Iterable[_Union[RelationshipDetails, _Mapping]]
        ] = ...,
    ) -> None: ...
