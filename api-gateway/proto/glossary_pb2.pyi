...
class Term(_message.Message):
    __slots__ = ("id", "name", "definition", "related_terms")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DEFINITION_FIELD_NUMBER: _ClassVar[int]
    RELATED_TERMS_FIELD_NUMBER: _ClassVar[int]
    id: str
    name: str
    definition: str
    related_terms: _containers.RepeatedCompositeFieldContainer[Term]
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., definition: _Optional[str] = ..., related_terms: _Optional[_Iterable[_Union[Term, _Mapping]]] = ...) -> None: ...
